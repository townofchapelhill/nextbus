...
bus_file = "//CHFS/Shared Documents/OpenData/datasets/staging/transit/nextbusroutes.xml"
...
def convert_to_csv():
    ...
    bus_data = open("//CHFS/Shared Documents/OpenData/datasets/staging/transit/nextbusroutes.csv", 'w')
